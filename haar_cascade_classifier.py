...
'''
#6 - arquivo com a descricao das imagens negativas
'''
...
'''
#7 - criar um diretorio para as coisas da imagem positiva
$ mkdir info 

#8 - criar amostras da imagem positiva:
...
#9 - criar diretorio para dados de treinemanto
$ mkdir data

#10 - treinar o classificador cascade:
opencv_traincascade -data data -vec positives.vec -bg bg.txt -numPos 1800 -numNeg 900 -numStages 10 -w 20 -h 20

#11 - rodar o classificador (na camera, aqui):
'''
